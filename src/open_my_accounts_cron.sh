#!/bin/bash
# Cron wrapper script for My Accounts Login Automation
...
mkdir -p "$LOG_DIR"
LOG_FILE="$LOG_DIR/open_my_accounts_cron.log"
ERROR_LOG="$LOG_DIR/open_my_accounts_cron.error.log"
...
"$PYTHON3" "$SCRIPT_DIR/open_my_accounts.py" >> "$LOG_FILE" 2>> "$ERROR_LOG"
