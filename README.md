...
│   └── README.md
├── open_Company_Account.py    # Company account (HDN374) script (570+ lines)
├── extensions/
...
### 2. Company Account: `open_Company_Account.py`
...
### 3. AlgoTest Login: `CronJob Algotest Login/algotest_login.py`
