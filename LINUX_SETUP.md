...
python3 src/auto_login.py --accounts BU0542,HDN374
...
**Note:** This script logs into HDN374 account and loads Chrome extensions.
...
BU0542,your_password,123456,1
HDN374,another_password,JBSWY3DPEHPK3PXP,1
```
